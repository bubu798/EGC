...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        CreateMesh("tetraed", vertices2, indices2);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-3.0f, 0.5f, 1), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraed"], shaders["VertexColor"], glm::vec3(2.5f, 0.5f, 1), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 1), glm::vec3(0.25f));

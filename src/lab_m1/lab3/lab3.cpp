...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    //translateX1 += deltaTimeSeconds * 50;
    //translateY1 += deltaTimeSeconds * 50;
    angularStep += 5;
    modelMatrix = glm::mat3(1);
    ...
    //translateX2+= deltaTimeSeconds * 70;
    //translateY2 += deltaTimeSeconds * 70;
    scaleX += deltaTimeSeconds * 2;
    scaleY += deltaTimeSeconds * 2;
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Scale(cx, cy);
    modelMatrix *= transform2D::Translate(scaleX, scaleY);
    modelMatrix *= transform2D::Scale(-cx, -cy);
    // TODO(student): Create animations by multiplying the current
    // transform matrix with the matrices you just implemented
    // Remember, the last matrix in the chain will take effect first!
